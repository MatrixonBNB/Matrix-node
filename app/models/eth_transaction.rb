class EthTransaction < ApplicationRecord
  ...
  has_many :eth_calls, primary_key: :tx_hash, foreign_key: :transaction_hash, dependent: :delete_all
  has_one :ethscription, primary_key: :tx_hash, foreign_key: :transaction_hash, dependent: :delete
  has_many :facet_transactions, -> { order(eth_call_index: :asc) },
    primary_key: :tx_hash, foreign_key: :eth_transaction_hash, dependent: :delete_all
