...
module Eth::Abi::Decoder
  ...
  #
  # source://eth//lib/eth/abi/decoder.rb#82
...
module Eth::Abi::Event
  ...
  #
  # source://eth//lib/eth/abi/event.rb#116
...
# A decoded event log.
#
# source://eth//lib/eth/abi/event.rb#48
class Eth::Abi::Event::LogDescription
  ...
  #
  # source://eth//lib/eth/abi/event.rb#50
  ...
  #
  # source://eth//lib/eth/abi/event.rb#56
  def kwargs; end
  ...
  #
  # source://eth//lib/eth/abi/event.rb#78
  def name; end

  # The event signature. (e.g. Transfer(address,address,uint256))
  #
  # source://eth//lib/eth/abi/event.rb#83
  def signature; end

  # The topic hash.
  #
  # source://eth//lib/eth/abi/event.rb#59
  def topic; end
...
class Eth::Abi::Type
  ...
  #
  # source://eth//lib/eth/abi/type.rb#130
  def dynamic?; end
  ...
  #
  # source://eth//lib/eth/abi/type.rb#137
  def nested_sub; end
  ...
  #
  # source://eth//lib/eth/abi/type.rb#113
  def size; end
  ...
  #
  # source://eth//lib/eth/abi/type.rb#144
  def to_s; end
  ...
  #
  # source://eth//lib/eth/abi/type.rb#161
  ...
  class << self
    ...
    #
    # source://eth//lib/eth/abi/type.rb#96
    def size_type; end
  end
end
...
class Eth::Client
  ...
  #
  # source://eth//lib/eth/client.rb#59
  def initialize(_); end

  # source://eth//lib/eth/client.rb#390
  ...
  #
  # source://eth//lib/eth/client.rb#251
  ...
  #
  # source://eth//lib/eth/client.rb#79
  def chain_id; end
  ...
  #
  # source://eth//lib/eth/client.rb#71
  ...
  #
  # source://eth//lib/eth/client.rb#213
  ...
  #
  # source://eth//lib/eth/client.rb#187
  ...
  #
  # source://eth//lib/eth/client.rb#87
  ...
  #
  # source://eth//lib/eth/client.rb#95
  ...
  #
  # source://eth//lib/eth/client.rb#335
  ...
  # @return [Integer] 0
  #
  # source://eth//lib/eth/client.rb#348
  def reset_id; end
  ...
  #
  # source://eth//lib/eth/client.rb#105
  ...
  #
  # source://eth//lib/eth/client.rb#292
  ...
  # @return [Object] returns the result of the transaction.
  #
  # source://eth//lib/eth/client.rb#316
  ...
  #
  # source://eth//lib/eth/client.rb#138
  ...
  #
  # source://eth//lib/eth/client.rb#117
  ...
  # @return [Object] returns the result of the transaction.
  #
  # source://eth//lib/eth/client.rb#176
  ...
  # @return [Object] returns the result of the transaction.
  #
  # source://eth//lib/eth/client.rb#153
  ...
  #
  # source://eth//lib/eth/client.rb#356
  ...
  #
  # source://eth//lib/eth/client.rb#365
  ...
  #
  # source://eth//lib/eth/client.rb#375
  ...
  #
  # source://eth//lib/eth/client.rb#458
  ...
  #
  # source://eth//lib/eth/client.rb#444
  def call_raw(contract, func, *args, **kwargs); end

  # expects Hash object
  #
  # source://eth//lib/eth/client.rb#490
  def camelize!(params); end

  # Encodes constructor params
  #
  # source://eth//lib/eth/client.rb#465
  ...
  # @return [Boolean]
  #
  # source://eth//lib/eth/client.rb#398
  def local?; end

  # Recursively marshals all request parameters.
  #
  # source://eth//lib/eth/client.rb#499
  def marshal(params); end

  # Increments the request id.
  #
  # source://eth//lib/eth/client.rb#485
  def next_id; end
  ...
  class << self
    ...
    #
    # source://eth//lib/eth/client.rb#51
    def create(host); end
  end
end
...
class Eth::Contract::Event
  ...
  # source://eth//lib/eth/contract/event.rb#38
...
module Eth::Eip712
  ...
  #
  # source://eth//lib/eth/eip712.rb#151
  ...
  #
  # source://eth//lib/eth/eip712.rb#167
  def hash(data); end
  ...
  #
  # source://eth//lib/eth/eip712.rb#140
