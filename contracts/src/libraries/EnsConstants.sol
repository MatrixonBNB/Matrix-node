...
// @param FACET_ETH_NODE The node hash of "facet.eth"
...
// @param FACET_REVERSE_NODE The ENSIP-19 compliant facet-specific reverse node hash of "800face7.reverse"
...
// @param FACET_ETH_NAME The dnsName of "facet.eth" returned by NameEncoder.dnsEncode("facet.eth")
