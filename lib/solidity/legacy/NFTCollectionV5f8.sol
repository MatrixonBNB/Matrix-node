...
contract NFTCollectionV5f8 is FacetERC721, FacetERC2981, Upgradeable, FacetOwnable, Pausable, Initializable {
    ...
    function _handleMint(
        ...
        uint256 initialId = s().totalSupply + 1;
    ...
    function setMetadataRenderer(address metadataRenderer, string memory data) public onlyOwner {
        s().metadataRenderer = metadataRenderer;
        (bool success, ) = metadataRenderer.call(abi.encodePacked(data));
