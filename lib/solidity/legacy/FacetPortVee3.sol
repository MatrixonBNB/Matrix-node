...
contract FacetPortVee3 is Upgradeable, FacetOwnable, Pausable, Initializable, FacetEIP712 {
    ...
    function _payRoyaltiesAndTransfer(
        ...
        uint256 sellerAmount = considerationAmount - royaltyAmount - computeFee(considerationAmount);
        ERC20(considerationToken).transferFrom(buyer, seller, sellerAmount);
        ERC20(considerationToken).transferFrom(buyer, owner(), computeFee(considerationAmount));
